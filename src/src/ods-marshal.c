...
/* NONE:STRING,STRING,UINT64 (ods-marshal.list:1) */
void
ods_marshal_VOID__STRING_STRING_UINT64 (GClosure     *closure,
...
/* NONE:UINT64 (ods-marshal.list:2) */
void
ods_marshal_VOID__UINT64 (GClosure     *closure,
                          GValue       *return_value G_GNUC_UNUSED,
                          guint         n_param_values,
                          const GValue *param_values,
                          gpointer      invocation_hint G_GNUC_UNUSED,
...
/* NONE:STRING,STRING (ods-marshal.list:3) */
void
ods_marshal_VOID__STRING_STRING (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
/* NONE:STRING,STRING,STRING (ods-marshal.list:4) */
void
ods_marshal_VOID__STRING_STRING_STRING (GClosure     *closure,
                                        GValue       *return_value G_GNUC_UNUSED,
                                        guint         n_param_values,
                                        const GValue *param_values,
                                        gpointer      invocation_hint G_GNUC_UNUSED,
...
/* NONE:STRING,BOOLEAN (ods-marshal.list:5) */
void
ods_marshal_VOID__STRING_BOOLEAN (GClosure     *closure,
                                  GValue       *return_value G_GNUC_UNUSED,
                                  guint         n_param_values,
                                  const GValue *param_values,
                                  gpointer      invocation_hint G_GNUC_UNUSED,
